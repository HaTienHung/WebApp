...
<body>
  <h6 class="border-b flex justify-center main-color py-[8px] text-[14px]">love is all round</h5>
    <header class="border-b">
      <div class="bg-white-200 flex font-sans items-center justify-between main-color px-[50px] py-[18px]">
        <nav>
          <ul class="flex items-center space-x-8">
            ...
            <li class="[&>span]:hover:hover-color cursor-pointer hover:underline underline-offset-4">
              <a href="/"><span>Trang chủ</span></a>
            </li>
            <li class="[&>span]:hover:hover-color cursor-pointer hover:underline underline-offset-4" id="dropdownRTW-button">
              <span>Quần áo</span>
              <div class=" [&>a]:block [&>a]:px-6 [&>a]:py-2 [&>a]:text-sm absolute bg-[#fffefc] border-[1px] h-auto hidden hover:[&>a]:hover-color ml-[-16px] mt-3 py-6 w-[196px] z-10" id="dropdownRTW-menu">
                <a href="{{route('product.showCategory',['category'=>'vay'])}}">Váy</a>
                <a>Áo</a>
                <a>Áo phông ngắn</a>
                <a>Quần</a>
                <a>Bộ đồ</a>
            ...
            <li class="[&>span]:hover:hover-color cursor-pointer hover:underline underline-offset-4" id="dropdownJewelry-button">
              <span>Trang sức</span>
            ...
            <li class="[&>span]:hover:hover-color cursor-pointer hover:underline underline-offset-4" id="dropdownAccessories-button">
              <span>Phụ kiện</span>
        ...
        <div class="flex items-center">
          <div class="relative">
            <input type="text" placeholder="Search" class="border-2 border-[#796449BF] focus:outline-none focus:shadow-outline main-color pl-8 placeholder:main-color px-4 py-1 rounded-full shadow-md w-72">
          </div>
