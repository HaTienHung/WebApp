...
<body>
  <h6 class="border-b flex justify-center main-color py-[8px] text-[14px] bg-[#fffefc]">love is all round</h6>
    ...
    <div class="bg-white-200 flex items-center justify-between main-color px-[50px] py-[18px]">
      ...
      <div class="flex items-center">
        ...
        <div class="flex items-center justify-between ml-8 space-x-4">
          <a class=" cursor-pointer duration-500 ease-in-out flex h-12 hover:scale-[1.05] items-center justify-center transition w-12" href="{{route('login')}}">
