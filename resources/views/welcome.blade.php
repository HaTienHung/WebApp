  ...
  <div>
    ...
    <main class="px-[50px] py-9 min-h-screen">
      ...
      <div class="flex justify-between text-[#796449BF]">
        <a class="w-[329px] h-[410px] cursor-pointer" href="/products">
          <div class="hover:underline underline-offset-2 text-sm [&>img]:hover:scale-[1.03]">
            <img class="transition duration-500 ease-in-out" src="https://13demarzo.net/cdn/shop/files/8_.25-02858.jpg?v=1694138281&width=720" alt="product-img">
